...
✅ Bundled scenario dataset (`edge_caching_case.json`) auto-loads for reproducible runs (India vs Pakistan cricket final — premium HD streams plus free highlight clips)
