...
with tab1:
    ...
    if st.button("Generate Plot", key="plot1"):
        with st.spinner("Running algorithms..."):
            ...
            ax.plot(Ns, y1, marker='o', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(Ns, y2, marker='s', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(Ns, y3, marker='^', label='Alg-3 Greedy', linewidth=2, markersize=8)
...
with tab2:
    ...
    if st.button("Generate Plot", key="plot2"):
        with st.spinner("Running algorithms..."):
            ...
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.plot(caps, y1, marker='s', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(caps, y2, marker='s', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(caps, y3, marker='s', label='Alg-3 Greedy', linewidth=2, markersize=8)
...
with tab3:
    ...
    if st.button("Generate Plot", key="plot3"):
        with st.spinner("Running algorithms..."):
            ...
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.plot(Ks, y1, marker='d', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(Ks, y2, marker='d', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(Ks, y3, marker='d', label='Alg-3 Greedy', linewidth=2, markersize=8)
...
with tab4:
    ...
    if st.button("Generate Plot", key="plot4"):
        with st.spinner("Running algorithms..."):
            ...
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.plot(scales, y1, marker='^', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(scales, y2, marker='^', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(scales, y3, marker='^', label='Alg-3 Greedy', linewidth=2, markersize=8)
...
with tab5:
    ...
    if st.button("Generate Plot", key="plot5"):
        with st.spinner("Running algorithms..."):
            ...
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.plot(alphas, y1, marker='o', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(alphas, y2, marker='o', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(alphas, y3, marker='o', label='Alg-3 Greedy', linewidth=2, markersize=8)
...
with tab6:
    ...
    if st.button("Generate Plot", key="plot6"):
        with st.spinner("Running algorithms..."):
            ...
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.plot(sigmas, r1, marker='o', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(sigmas, r2, marker='o', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(sigmas, r3, marker='o', label='Alg-3 Greedy', linewidth=2, markersize=8)
...
with tab7:
    ...
    if st.button("Generate Plot", key="plot7"):
        with st.spinner("Running algorithms..."):
            ...
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.plot(boosts, y1, marker='s', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(boosts, y2, marker='s', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(boosts, y3, marker='s', label='Alg-3 Greedy', linewidth=2, markersize=8)
...
with tab8:
    ...
    if st.button("Generate Plot", key="plot8"):
        with st.spinner("Running algorithms..."):
            ...
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.plot(steps, y1, marker='^', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(steps, y2, marker='^', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(steps, y3, marker='^', label='Alg-3 Greedy', linewidth=2, markersize=8)
...
with tab9:
    ...
    if st.button("Generate Plot", key="plot9"):
        with st.spinner("Running algorithms..."):
            ...
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.plot(uppers, y1, marker='o', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(uppers, y2, marker='o', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(uppers, y3, marker='o', label='Alg-3 Greedy', linewidth=2, markersize=8)
...
with tab10:
    ...
    if st.button("Generate Plot", key="plot10"):
        with st.spinner("Running algorithms..."):
            ...
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.plot(lambdas, y1, marker='d', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(lambdas, y2, marker='d', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(lambdas, y3, marker='d', label='Alg-3 Greedy', linewidth=2, markersize=8)
...
with tab12:
    ...
    if st.button("Generate Plot", key="plot12"):
        with st.spinner("Running algorithms..."):
            ...
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.plot(bands, y1, marker='o', label='Alg-1 GenAI-RAG', linewidth=2, markersize=8)
            ax.plot(bands, y2, marker='o', label='Alg-2 Pure Stackelberg', linewidth=2, markersize=8)
            ax.plot(bands, y3, marker='o', label='Alg-3 Greedy', linewidth=2, markersize=8)
